...
export interface TrivialEncryption$Type {
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<TrivialEncryption$Type["abi"]>>;
  export function deployContract(
    contractName: "@inco/lightning/src/lightning-parts/TrivialEncryption.sol:TrivialEncryption",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<TrivialEncryption$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<TrivialEncryption$Type["abi"]>;
