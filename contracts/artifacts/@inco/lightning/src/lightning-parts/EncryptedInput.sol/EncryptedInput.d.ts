...
export interface EncryptedInput$Type {
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<EncryptedInput$Type["abi"]>>;
  export function deployContract(
    contractName: "@inco/lightning/src/lightning-parts/EncryptedInput.sol:EncryptedInput",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<EncryptedInput$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<EncryptedInput$Type["abi"]>;
